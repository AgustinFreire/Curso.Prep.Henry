...
describe('mayorQueCincuenta(num)', function() {
  xit('Deberia devolver true si el numero es mayor a cincuenta sino false', function() {
...
describe('obtenerResto(x, y)', function() {
  xit('Deberia devolver el resto de dividir x sobre y', function() {
...
describe('esPar(num)', function() {
  xit('Deberia devolver true si el numero es par sino false', function() {
...
describe('elevarAlCubo(num)', function() {
  xit('Deberia devolver el numero elevado al cubo', function() {
...
describe('redondearNumero(num)', function() {
  xit('Deberia devolver el numero redondeado', function() {
...
describe('redondearHaciaArriba(num)', function() {
  xit('Deberia devolver el numero redondeado para arriba', function() {
...
describe('numeroRandom()', function() {
  xit('Debería devolver un número entre 0 y 1', function() {
...
describe('agregarSimboloExclamacion(str)', function() {
  xit('Deberia agregar un signo de exclamacion al final del string', function() {
...
describe('obtenerSaludo(name)', function() {
  xit('Deberia devolver el string \'Hola {name}!\'', function() {
